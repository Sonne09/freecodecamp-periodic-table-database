...
--
-- Name: properties properties_tpe_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT properties_tpe_id_fkey FOREIGN KEY (type_id) REFERENCES public.types(type_id);
